...
public record CriaFuncionarioForm(String nome, Sexo sexo, String RG, String telefone, String email, LocalDate dataDeNascimento,
		CriaEnderecoForm endereco, String registro, Cargo cargo) {

	public CriaFuncionarioForm(String nome, Sexo sexo, String RG, String telefone, String email, LocalDate dataDeNascimento,
	CriaEnderecoForm endereco, String registro, Cargo cargo) {
