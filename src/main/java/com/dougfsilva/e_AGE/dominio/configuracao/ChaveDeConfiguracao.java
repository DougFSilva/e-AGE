...
public enum ChaveDeConfiguracao {
	...
	ENVIAR_EMAIL_AO_ABRIR_OCORRENCIA(List.of("SIM", "NAO")), 
	ENVIAR_EMAIL_AO_EXCLUIR_OCORRENCIA(List.of("SIM", "NAO")),
	ENVIAR_EMAIL_AO_ATUALIZAR_OCORRENCIA(List.of("SIM", "NAO")),
	ENVIAR_EMAIL_AO_ENCERRAR_OCORRENCIA(List.of("SIM", "NAO")),
	ENVIAR_MENSAGEM_AO_ABRIR_OCORRENCIA(List.of("SIM", "NAO")),
	ENVIAR_MENSAGEM_AO_EXCLUIR_OCORRENCIA(List.of("SIM", "NAO")),
	ENVIAR_MENSAGEM_AO_ATUALIZAR_OCORRENCIA(List.of("SIM", "NAO")),
	ENVIAR_MENSAGEM_AO_ENCERRAR_OCORRENCIA(List.of("SIM", "NAO"));
